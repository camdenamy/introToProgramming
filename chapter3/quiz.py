...
if not ready_or_not.startswith('n'):
    ...
    # If correct, inform user and increase score by 1
    ...
    print(
        "What is the flight speed of a laden swallow?:\n" 
        "A. 10 m/s\n" 
    ...
    print(
        "Which Fast & Furious movie almost ended the franchise?:\n" 
    ...
    print(
        "What movie is one of the best movies about games ever made?:\n" 
        "A. Gamer\n" 
        "B. Jumanji\n" 
        "C. Ready Player One\n" 
