...
if check_registered_voter in ('yes', 'y'):
    print("You are already registered. No further action is required.")
else:
    ...
    if citizen_check in ('yes', 'y'):
        ...
        ready_to_register = input("You will need your CA Driver's License number or CA ID number, the last 4 of your Social Security Number, and you Date of Birth. "
                "Do you have these? Type y for yes or n for no: "
                )
        if ready_to_register in ('yes', 'y'):
            ...
            if (age >= 16) and (age < 18):
                pre_register_check = input("You are only eligible to pre-register. Would you like to pre-register?: ").lower()
                # If yes, prompt user for information
                if pre_register_check in ('yes', 'y'):
                    print("Follow instructions at the home page to pre-register to vote.")
            ...
            # If over 18 user can register
                ...
                background_check = input("Are you currently incarcerated for a felony offense?: ").lower()
                ...
                # If no, move to next check
                    ...
                    address_check = input("Are you enrolled in a confidential address program?: ").lower()
